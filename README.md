...
## New features
-  Add the support of Numpy array. (np.float16/float32 as HDR image, np.uint8 as LDR image)
- [todo] image computation (add, multiply, etc.)
- [todo] display channels of image
- [todo] image resize
- [todo] other Error metric (SSIM, PSNR, LPips, etc.)
